...
@Service
public class ReportReviewAppServiceImpl implements ReportReviewAppService {

    private static final Logger log = LoggerFactory.getLogger(ReportReviewAppServiceImpl.class);
