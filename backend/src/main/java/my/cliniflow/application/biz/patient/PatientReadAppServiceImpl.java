...
public class PatientReadAppServiceImpl implements PatientReadAppService {

    private static final Logger log = LoggerFactory.getLogger(PatientReadAppServiceImpl.class);
    ...
    public PatientReadAppServiceImpl(
