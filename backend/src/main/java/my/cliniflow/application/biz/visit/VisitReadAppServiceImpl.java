...
public class VisitReadAppServiceImpl implements VisitReadAppService {

    private static final Logger log = LoggerFactory.getLogger(VisitReadAppServiceImpl.class);
    ...
    public VisitReadAppServiceImpl(VisitRepository visits, MedicalReportRepository reports,
