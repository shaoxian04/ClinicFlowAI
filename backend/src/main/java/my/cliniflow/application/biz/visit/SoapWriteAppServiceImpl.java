...
@Service
public class SoapWriteAppServiceImpl implements SoapWriteAppService {

    private static final Logger log = LoggerFactory.getLogger(SoapWriteAppServiceImpl.class);
